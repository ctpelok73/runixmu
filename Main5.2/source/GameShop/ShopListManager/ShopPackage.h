...
public:
	...
	int		DeleteFlag;											// 17. 삭제 여부 (180:삭제, 181:활 성)
	int		EventFlag;											// 18. 이벤트 상품 여부 (199:이벤 트 상품, 200:일반 상품)
	...
	int		PriceCount;											// 23. 단위 상품 가격 정책 보유 개 수 (단위 상품이 1개인 경우에만 PriceSeq가 여러 개일 수 있다.)
